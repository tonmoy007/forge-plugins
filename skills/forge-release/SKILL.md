...
4. Follow the Release Manager workflow: classify changes, determine version bump, write changelog and release notes.
5. Write `pipeline/12-release/CHANGELOG.md` and `pipeline/12-release/release-notes.md`.
