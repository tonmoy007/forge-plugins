...
5. Follow the Spec Writer workflow: enumerate interfaces, define types, write API specs, trace to REQ-IDs.
6. Write `pipeline/04-technical-spec/technical-spec.md` per the Output Contract.
